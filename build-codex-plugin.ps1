<#
.SYNOPSIS
    Synchronize the tracked Codex plugin package at plugins/shaughv-code/.
...
# but the guard below measures the repo-relative path (plugins/shaughv-code/...)
...
function Build-Package {
    ...
    Get-ChildItem -LiteralPath $Destination -Recurse -File -Force | ForEach-Object {
        ...
        $repoRel   = 'plugins/shaughv-code/' + $relToDest
        $len = $repoRel.Length
