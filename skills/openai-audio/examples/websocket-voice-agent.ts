// Server-side voice agent using gpt-realtime-2 — Node.js / TypeScript.
//
// REQUIREMENTS
// ------------
// Env vars:
...
// RUN
// ---
//   npx ts-node websocket-voice-agent.ts audio_samples/sample-en.wav
//
// EXPECTED OUTPUT
// ---------------
//   - Streaming transcript on stdout.
//   - response.pcm written to disk.
//   - --- usage --- block at end.
//
